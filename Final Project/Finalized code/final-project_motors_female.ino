  ...
  void loop()
  {
    ...
    if (button_state == 1)
    {
      ...
      switch (state) {
        ...
        case 0: // slowly enters scene
          forward();
          motionStartedAt = millis();
          state = 1;
          break;

        case 1: // continue forwards for 15 seconds
        ...
        case 3: // continue for a short moment
          if ((currentMillis - motionStartedAt) > 500) {
            state = 4;
          }
          break;


        case 4: // initiate stopping
          stopMotors();
          motionStartedAt = millis();
          state = 5;
          break;

        case 5: // continue for 13 seconds
          if ((currentMillis - motionStartedAt) > 13000) {
            state = 4;
          }
          break;

        case 6: // pacing back and forth
          motionStartedAt = millis();
          for (int i = 0; i < 12; i++) {
            forward();
            delay(400);
        ...
        case 7: // continue for 13 seconds
        ...
        case 9: // continue for 5 seconds
          if ((currentMillis - motionStartedAt) > 5000) {
            state = 10;
          }
          break;

        case 10: // initiate pacing
          motionStartedAt = millis();
          for (int i = 0; i < 20; i++) {
            forward();
            delay(400);
        ...
        case 11: // continue for 20 seconds

...
void firstMessage() {
  ...
  display.println("Message: Mission successful.");
  display.display();
}
...
void secondMessage() {
  display.clearDisplay();
  display.setCursor(0, 0);            // Start at top-left corner
  display.println("Message: Problem detected.");
  display.display();
}
...
void thirdMessage() {
  display.clearDisplay();
  display.setCursor(0, 0);            // Start at top-left corner
  display.println("Error 1: Resolved.");
  display.display();
}
...
void fourthMessage() {
  display.clearDisplay();
  display.setCursor(0, 0);            // Start at top-left corner
  display.println("Message: Trying forced approach.");
  display.display();
}
